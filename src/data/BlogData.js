...
export const Blogs = [
  {
    id: 1,
    name: "Build Website with ReactJS, and blockchain Styled-components and GSAP for Scrolling Animations",
  ...
  {
    id: 4,
    name: "How to build a Fabulous Todo App using React, Redux and Framer-Motion the code i am Blockchain devloper ",
